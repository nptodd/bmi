...
function [output] = bhm_mcmc(Y, T, delta, cgrid, Burnin, M, mat, Sigma_est, mu_est, pgrid, nu, c, w, ws, resid_thin, tol, log_transform)
...
%% if log transform, take log of MCMC posterior samples
